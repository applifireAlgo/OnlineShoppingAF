...
public class User implements Serializable, CommonEntityInterface, UserInterface, Comparator<User> {
    ...
    public User addPassRecovery(PassRecovery _passRecovery) {
        if (this.passRecovery == null) {
            this.passRecovery = new java.util.ArrayList<shop.app.shared.authentication.PassRecovery>();
        }
    ...
    public boolean equals(Object obj) {
        try {
            shop.app.shared.authentication.User other = (shop.app.shared.authentication.User) obj;
            if (userId == null) {
                return false;
