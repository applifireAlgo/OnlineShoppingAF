...
@SourceCodeAuthorClass(createdBy = "jack@doe.com", updatedBy = "", versionNumber = "1", comments = "Repository for UserAccessDomain Master table Entity", complexity = Complexity.LOW)
