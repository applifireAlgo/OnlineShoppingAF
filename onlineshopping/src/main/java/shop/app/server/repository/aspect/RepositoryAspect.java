package shop.app.server.repository.aspect;
...
public class RepositoryAspect {
    ...
    @Pointcut("execution(* shop.app.server.repository..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* shop.app.server.repository..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* shop.app.server.repository..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* shop.app.server.repository..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* shop.app.server.repository..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* shop.app.server.repository..*(..))")
