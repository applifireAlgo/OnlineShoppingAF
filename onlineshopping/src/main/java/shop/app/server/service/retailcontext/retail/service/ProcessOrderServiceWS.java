...
import shop.app.server.businessservice.retailcontext.retail.ProcessOrderService;

@RestController
@Scope(value = "request", proxyMode = ScopedProxyMode.TARGET_CLASS)
@RequestMapping("/ProcessOrderServiceWS")
public class ProcessOrderServiceWS {

    @Autowired
    private ProcessOrderService processorderservice;

    @RequestMapping(value = "/processOrder", consumes = "application/json", method = RequestMethod.POST)
    public HttpEntity<ResponseBean> processOrder() throws Exception, SpartanBusinessValidationFailedException, SpartanDataNotFoundException, SpartanIncorrectDataException, SpartanPersistenceException {
