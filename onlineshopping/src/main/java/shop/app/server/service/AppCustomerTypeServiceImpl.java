...
@SourceCodeAuthorClass(createdBy = "jack@doe.com", updatedBy = "", versionNumber = "1", comments = "Service for AppCustomerType Master table Entity", complexity = Complexity.LOW)
