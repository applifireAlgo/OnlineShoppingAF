package shop.app.server.service.aspect;
...
public class ServiceAspect {
    ...
    @Pointcut("execution(* shop.app.server.service..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* shop.app.server.service..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* shop.app.server.service..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* shop.app.server.service..*..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void allOperation() {
    }

    @Pointcut("execution(* shop.app.server.service..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* shop.app.server.service..get*(..))")
