...
public class ItemServiceImpl extends ItemService {
    ...
    @Override
    public HttpEntity<ResponseBean> findByProduct(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        com.athena.framework.server.bean.ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            List<shop.app.shared.retail.Item> lstitem = itemrepo.findByProduct((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstitem);
        } catch (org.springframework.transaction.TransactionException e) {
    ...
    @Override
    public HttpEntity<ResponseBean> findByBrand(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        com.athena.framework.server.bean.ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            List<shop.app.shared.retail.Item> lstitem = itemrepo.findByBrand((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstitem);
        } catch (org.springframework.transaction.TransactionException e) {
    ...
    public HttpEntity<ResponseBean> findByCategory(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            List<shop.app.shared.retail.Item> lstitem = itemrepo.findByCategory((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstitem);
        } catch (org.springframework.transaction.TransactionException e) {
    ...
    @RequestMapping(value = "/FetchItemDetails/{itemId}", method = RequestMethod.POST)
    @Override
    public HttpEntity<ResponseBean> FetchItemDetails(@PathVariable String itemId) throws SpartanPersistenceException, Exception {
        com.athena.framework.server.bean.ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        java.util.List<shop.app.shared.retail.Item> lstitem = itemrepo.FetchItemDetails(itemId);
        responseBean.add("success", true);
        responseBean.add("message", "Successfully retrived ");
        responseBean.add("data", lstitem);
        return new org.springframework.http.ResponseEntity<ResponseBean>(responseBean, httpStatus);
