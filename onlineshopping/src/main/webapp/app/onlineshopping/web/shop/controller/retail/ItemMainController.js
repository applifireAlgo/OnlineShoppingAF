Ext.define('Onlineshopping.onlineshopping.web.shop.controller.retail.ItemMainController', {
     ...
     productLoad: function() {
          ...
          Ext.Ajax.request({
               ...
               success: function(response, scope) {
                    var compRef = scope.sender.down('#product');
                    scope.sender.controller.assignAllComboData(scope.sender, 'product', response.responseText);
     ...
     onProductChange: function(me, newValue, oldValue, eOpts) {
          this.onProductChangeBrand(me, newValue, oldValue, eOpts);
          this.onProductChangeCategory(me, newValue, oldValue, eOpts);
     },
     onBrandChange: function(me, newValue, oldValue, eOpts) {
          this.onBrandChangeCategory(me, newValue, oldValue, eOpts);
     },
     onProductChangeBrand: function(me, newValue, oldValue, eOpts) {
          debugger;
          var scope = this.getView();
          Ext.Ajax.request({
               async: false,
               url: 'secure/Brand/findByProduct',
               method: 'POST',
               jsonData: {
                    findKey: newValue
               },
               ...
               element: me,
               success: function(response, scope) {
                    var brandCombo = scope.element.up('form').down('#brand');
                    scope.sender.controller.assignComboData(brandCombo, response.responseText);
                    scope.sender.controller.addCommunicationLog(response, true, brandCombo);
               },
               failure: function(response, scope) {
                    debugger;
     ...
     onProductChangeCategory: function(me, newValue, oldValue, eOpts) {
          debugger;
          var scope = this.getView();
          Ext.Ajax.request({
               async: false,
               url: 'secure/Category/findByProduct',
               method: 'POST',
               jsonData: {
                    findKey: newValue
               },
               ...
               element: me,
               success: function(response, scope) {
                    var categoryCombo = scope.element.up('form').down('#category');
                    scope.sender.controller.assignComboData(categoryCombo, response.responseText);
                    scope.sender.controller.addCommunicationLog(response, true, categoryCombo);
               },
               failure: function(response, scope) {
                    debugger;
                    scope.sender.controller.addCommunicationLog(response, false);
     ...
     onBrandChangeCategory: function(me, newValue, oldValue, eOpts) {
          debugger;
          var scope = this.getView();
          Ext.Ajax.request({
               async: false,
               url: 'secure/Category/findByBrand',
               method: 'POST',
               jsonData: {
                    findKey: newValue
               },
