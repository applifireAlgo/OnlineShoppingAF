 ...
 * 
 */
Ext.define('Onlineshopping.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Onlineshopping.view.securityconfig.SecurityConfigController',
			'Onlineshopping.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
