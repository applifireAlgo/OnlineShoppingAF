Ext.define('Onlineshopping.view.reportbuilder.querycriteria.QueryCriteriaView', {
	extend : 'Ext.grid.Panel',
	requires:['Onlineshopping.view.reportbuilder.querycriteria.QueryCriteriaController',
	          'Onlineshopping.store.QueryCriteriaWidgetsStore',
	          'Ext.grid.RowEditor',
	          'Onlineshopping.view.reportbuilder.querycriteria.QueryCriteriaModel'
	          ],
	...
	columns : [
				...
				},
				{
					...
					editor : {
						...
						store : 'Onlineshopping.store.QueryCriteriaWidgetsStore',
						queryMode : 'local',
						forceSelection : true,
						triggerAction : 'all',
						selectOnFocus : true,
