Ext.define('Onlineshopping.view.reportbuilder.properties.RptDataEndPointGridView', {
	extend : 'Ext.grid.Panel',
	requires:['Onlineshopping.view.reportbuilder.properties.RptDataEndPointGridController'],
