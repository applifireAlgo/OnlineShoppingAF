Ext.define('Onlineshopping.view.reportbuilder.properties.RptChartPropGridView', {
	extend : 'Ext.grid.Panel',
	requires:['Onlineshopping.view.reportbuilder.properties.RptChartPropGridController'],
