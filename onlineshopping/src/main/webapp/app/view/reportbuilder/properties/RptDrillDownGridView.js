Ext.define('Onlineshopping.view.reportbuilder.properties.RptDrillDownGridView', {
	extend : 'Ext.grid.Panel',
	requires:['Onlineshopping.view.reportbuilder.properties.RptDrillDownGridController'],
