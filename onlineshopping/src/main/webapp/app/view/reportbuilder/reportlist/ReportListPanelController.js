Ext.define('Onlineshopping.view.reportbuilder.reportlist.ReportListPanelController',{
	    	...
	    	Ext.Ajax.request(
	    	{
	    		...
	    		success:function(response, currentObject,options) 
	    		{
	    			...
	    			if (responseJson.response.success == 'true') 
	    			{
			    		...
			    		debugger;
			    		var tab=Ext.create('Onlineshopping.view.reportbuilder.reportBuilder.ReportBuilderView', //activeTab
			    		{
			    			closable:true,
			    			iconCls:'editTabIcon',
