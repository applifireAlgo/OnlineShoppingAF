Ext.define('Onlineshopping.view.reportbuilder.reportlist.ReportListPanelView', {
	extend : 'Ext.panel.Panel',
	requires:['Onlineshopping.view.reportbuilder.reportlist.ReportListPanelController'],
