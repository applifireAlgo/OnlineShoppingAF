Ext.define('Onlineshopping.view.reportbuilder.mainview.ReportMainView', {
	extend : 'Ext.panel.Panel',
    requires:[
             'Onlineshopping.view.reportbuilder.reportlist.ReportListPanelView',
             'Onlineshopping.view.reportbuilder.reportBuilder.ReportBuilderView',
             'Onlineshopping.view.reportbuilder.mainview.ReportMainController'
             ],
