Ext.define('Onlineshopping.view.reportbuilder.mainview.ReportMainController',{
    	    		    	    		 ...
    	    		    	    		 var newReportName=this.up().up().down('#new-report-name').value;
        	    		    		   	 ...
        	    		    		   	 if(newReportName!="")
        	       		    	    		...
        	       		    	    		var tabs= view.down("#reportsTabPanel");     		    		    			   
        	       		   		    		var tab=Ext.create('Onlineshopping.view.reportbuilder.reportBuilder.ReportBuilderView',
        	       		   		    		{
        	       		   		    			closable:true,
        	       		   		    			title:newReportName,
        	       		   		    			iconCls:'newTabIcon',
