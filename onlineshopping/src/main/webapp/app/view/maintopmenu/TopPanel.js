 ...
 */
Ext.define('Onlineshopping.view.maintopmenu.TopPanel', {
	extend : 'Ext.toolbar.Toolbar',
	xtype : 'topToolbar',
	
	requires : [ 'Onlineshopping.view.maintopmenu.TopPanelController',
	             'Onlineshopping.view.maintopmenu.MenuPanel' ],
