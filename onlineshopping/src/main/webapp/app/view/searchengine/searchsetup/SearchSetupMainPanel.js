 ...
 * 
 */
Ext.define('Onlineshopping.view.searchengine.searchsetup.SearchSetupMainPanel', 
{
	extend : 'Ext.panel.Panel',
	xtype : 'searchsetup',
	requires : [ 'Ext.layout.container.HBox', 'Ext.layout.container.VBox', 'Onlineshopping.view.searchengine.searchsetup.SearchSetupMainPanelController',
	             'Onlineshopping.view.searchengine.searchsetup.ChartFieldsModel',
	           ],
