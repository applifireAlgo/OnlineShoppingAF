Ext
		.define(
				'Onlineshopping.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Onlineshopping.view.searchengine.search.SearchEngineMainPanelController','Onlineshopping.view.searchengine.search.PanelHeaderField' ,'Onlineshopping.view.searchengine.search.ReportGridView','Onlineshopping.view.searchengine.search.ReportChartView','Onlineshopping.view.searchengine.search.documentView','Onlineshopping.view.searchengine.search.DouMeanView','Onlineshopping.view.googlemaps.map.MapPanel'],
