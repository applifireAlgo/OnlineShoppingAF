...
Ext
		.define(
				'Onlineshopping.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Onlineshopping.view.logger.tabs.details.DetailsTab',
							'Onlineshopping.view.logger.tabs.fileconnector.FileConnectorTab',
							'Onlineshopping.view.logger.tabs.dbconnector.DBConnectorTab',
							'Onlineshopping.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Onlineshopping.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Onlineshopping.view.logger.LogConfigurationTabPanelController',
