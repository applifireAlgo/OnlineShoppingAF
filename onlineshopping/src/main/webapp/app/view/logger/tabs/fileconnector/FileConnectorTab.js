 ...
 * 
 */
Ext.define('Onlineshopping.view.logger.tabs.fileconnector.FileConnectorTab', {
	...
	requires : ['Onlineshopping.view.logger.tabs.fileconnector.FileConnectorTabController'],
