 ...
 * 
 */
Ext.define('Onlineshopping.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Onlineshopping.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
