Ext.define('Onlineshopping.view.art.masterform.MasterPanelController', {
	     ...
	     Ext.Ajax.request(
 	             {
 	                 ...
 	                 success : function(response,currentObject){
 	                	 ...
 	                	 debugger;
 	                	  var masterFormPanelViewModel = Ext.create('Onlineshopping.view.art.masterform.MasterFormViewModel');
 	                	  ...
 	                	  var newFormPanelViewModel = Ext.create('Onlineshopping.view.art.masterform.MasterFormViewModel');
