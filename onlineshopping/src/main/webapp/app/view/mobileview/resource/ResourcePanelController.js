Ext.define('Onlineshopping.view.mobileview.resource.ResourcePanelController', {
		...
		debugger;
				...
				for (var j = 0; j < this.formResourcePanel.items.length; j++) {
					...
					if(me.formResourcePanel.items.items[j].title == record.menuLabel)
						{
							var treePanel = new Ext.create('Onlineshopping.view.mobileview.resource.AppMenuTreePanel');
