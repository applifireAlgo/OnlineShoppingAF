Ext.define('Onlineshopping.view.mobileview.main.TopPanel.TopMenu', { 
	extend: 'Ext.toolbar.Toolbar',
    xtype: 'topMenu',
    requires:['Onlineshopping.view.mobileview.main.TopPanel.TopMenuController',/*'Onlineshopping.view.mobileview.main.ResourceWindow'*/],
        ...
        items: [
                {		text: 'Resorces',
                		handler:function(panel,e,eOpts)
                    	{
                    		debugger;
                    		var westAccodianPanel = this.up().up().up().up().up().down('#appMenuTreePanel');
                    		var resourceWindow = Ext.create('Onlineshopping.view.mobileview.main.ResourceWindow');
