Ext.define('Onlineshopping.view.mobileview.main.TopPanel.TopPanelController', {
	...
	onSearchClick : function(button) {
		...
		//	"Onlineshopping.view.mobileview.scheduler.scheduler"
		var component = Ext.create(
				"Onlineshopping.view.mobileview.searchengine.search.SearchEngineMainPanel", {
					closable : true,
					title : "Search Engine",
					refId : "-1"
				});
	...
	{
		var component = Ext.create(
				"Onlineshopping.view.mobileview.clouddrive.CloudDrive", {
					closable : true,
					title : "Cloud Drive",
					//refId : "-1"
				});
