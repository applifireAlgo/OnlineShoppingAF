Ext
		.define(
				'Onlineshopping.view.mobileview.reportui.querycriteria.QueryCriteriaView',
				{
					extend : 'Ext.panel.Panel',
					requires : [ 'Onlineshopping.view.mobileview.reportui.querycriteria.QueryCriteriaController' ],
					xtype : 'querycriteria',
