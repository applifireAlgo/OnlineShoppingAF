Ext.define('Onlineshopping.view.chartbuilder.chartjsonsource.ChartJsonSourceView', {
	
	extend : 'Ext.panel.Panel',
	requires : [ 'Ext.layout.container.Column',
	             'Onlineshopping.view.chartbuilder.chartjsonsource.ChartJsonSourceController'
	           ],
	xtype : 'source-view',
	itemId:'sourceView',
