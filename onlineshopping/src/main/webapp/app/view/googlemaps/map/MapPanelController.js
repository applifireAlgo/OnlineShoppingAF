Ext.define('Onlineshopping.view.googlemaps.map.MapPanelController', {
	...
	createInfoWindow : function(marker, currentJson) {
		...
		google.maps.event.addListener(marker, 'click', function() {
			...
			// mainInfoWindow =
			// Ext.create('Onlineshopping.view.googlemaps.map.MarkerInfoWindowView',{title:
	...
	loadGoogleMap : function() {
		...
		// Ext.create('Onlineshopping.view.googlemaps.map.MarkerInfoWindowView').show();
	},
	resizeMap : function() {
