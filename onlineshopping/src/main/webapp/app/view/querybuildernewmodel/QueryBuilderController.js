Ext.define('Onlineshopping.view.querybuildernewmodel.QueryBuilderController', {
	extend : 'Ext.app.ViewController',
	alias : 'controller.query-builder',
	requires:['Onlineshopping.view.querybuildernewmodel.queryentitiesjoins.QueryFieldsStore',
	          'Onlineshopping.view.querybuildernewmodel.queryentitiesjoins.QueryEntitiesStore',
	          'Onlineshopping.view.querybuildernewmodel.queryentitiesjoins.EntityJoinStore',
	...
	openQueryDetailWindow : function(saveBtn){
		...
		var queryWindow = Ext.create('Onlineshopping.view.querybuildernewmodel.querydetail.QueryDetail');
