Ext.define('Onlineshopping.view.querybuildernewmodel.floatingentity.FloatingEntityController',
{
			extend : 'Ext.app.ViewController',
			alias : 'controller.floating-entity',
			requires:['Onlineshopping.view.querybuildernewmodel.floatingentity.EntityColumnGrid',
			          'Onlineshopping.view.querybuildernewmodel.queryentitiesjoins.Query',
			          'Onlineshopping.view.querybuildernewmodel.floatingentity.EntitySprite',
