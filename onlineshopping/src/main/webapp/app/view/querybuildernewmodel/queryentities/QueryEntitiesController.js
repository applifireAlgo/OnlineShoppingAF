Ext.define('Onlineshopping.view.querybuildernewmodel.queryentities.QueryEntitiesController', {
	extend : 'Ext.app.ViewController',
	alias : 'controller.query-entities-tree',
	requires:['Onlineshopping.view.querybuildernewmodel.floatingentity.FloatingEntity','Ext.tree.*'],
	entTreePanel:null,
	queryBuilder :null,
	draggedRecord:null,
	init:function(){
