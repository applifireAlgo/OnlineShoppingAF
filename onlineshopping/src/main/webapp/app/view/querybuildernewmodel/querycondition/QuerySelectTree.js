Ext.define('Onlineshopping.view.querybuildernewmodel.querycondition.QuerySelectTree', {
	extend : 'Ext.tree.TreePanel',
	requires:['Onlineshopping.view.querybuildernewmodel.querycondition.QuerySelectController',
