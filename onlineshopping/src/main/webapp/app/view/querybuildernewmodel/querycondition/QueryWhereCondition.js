Ext.define('Onlineshopping.view.querybuildernewmodel.querycondition.QueryWhereCondition', {
	extend : 'Ext.tree.TreePanel',
	requires:['Onlineshopping.view.querybuildernewmodel.querycondition.QueryWhereConditionController'],
