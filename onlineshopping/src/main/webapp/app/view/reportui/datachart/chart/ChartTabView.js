Ext.define('Onlineshopping.view.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Onlineshopping.view.reportui.datachart.chart.RatingField','Onlineshopping.view.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
