 ...
 * 
 */
Ext.define("Onlineshopping.view.scheduleconfiguration.tree.ScheduleConfigTree", {
	extend : 'Ext.panel.Panel',
	requires : [ 'Onlineshopping.view.scheduleconfiguration.tree.ScheduleConfigTreeController' ],
