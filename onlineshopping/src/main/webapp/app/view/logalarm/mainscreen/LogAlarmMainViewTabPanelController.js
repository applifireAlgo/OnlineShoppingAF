 ...
 * 
 */
Ext.define('Onlineshopping.view.logalarm.mainscreen.LogAlarmMainViewTabPanelController', {
	...
	{
		debugger;
		var component = Ext.create("Onlineshopping.view.logalarm.mainscreen.AddLogAlarm", {
			title : "Log Module",
		});
