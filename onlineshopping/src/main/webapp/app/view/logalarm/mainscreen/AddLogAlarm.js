 ...
 * 
 */
Ext.define('Onlineshopping.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Onlineshopping.view.logalarm.mainscreen.AddLogAlarmController',
			'Onlineshopping.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Onlineshopping.view.logalarm.mainscreen.AppAlarmPanel',
