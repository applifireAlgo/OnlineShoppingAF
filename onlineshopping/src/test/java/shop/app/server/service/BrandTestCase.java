...
public class BrandTestCase {
    ...
    public void test1Save() {
        try {
            ...
            product.setProductName("NC9H6layw3nnon5ryshN43mj0io42v9ao17ouoI0m356slJwYq");
            Product ProductTest = productRepository.save(product);
            map.put("ProductPrimaryKey", product._getPrimarykey());
            Brand brand = new Brand();
            brand.setBrandName("4rWMDAfw1Du2PZhGm8vIh9U2c7aW5vs0mG0K0m37lRxXpG4GZg");
            brand.setProduct((java.lang.String) ProductTest._getPrimarykey());
    ...
    public void test2Update() {
        try {
            ...
            brand.setBrandName("MMB5mQiBLIQzsYEcfy1yna4m0Pbg0dOd9hCR6iKPs0LY1SQwhz");
    ...
    public void test3findByproduct() {
        try {
            java.util.List<Brand> listofproduct = brandRepository.findByProduct((java.lang.String) map.get("ProductPrimaryKey"));
